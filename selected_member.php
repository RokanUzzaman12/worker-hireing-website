...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <?php
      $member_id = $_GET['sel_member'];
      $mem_profile_query = "SELECT * FROM members WHERE mem_id = '$member_id' ";
    ...
    ?>
      ...
      <img class="imgl borderedbox inspace-5" src="images/<?php echo $mem_image;?>" style="height:300px; width:300px" alt="">
